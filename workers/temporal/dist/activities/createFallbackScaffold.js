...
function buildMarketingPageBody(page, componentName, projectName, promptSummary) {
...
function buildDashboardPageBody(page, componentName, projectName) {
...
function buildWorkspacePageBody(page, componentName, projectName) {
    if (page.kind === "board") {
        return `export default function ${componentName}() {
...
function createRouteFile(template, page, projectName, promptSummary) {
    return {
...
export async function createFallbackScaffold(input) {
    ...
    return {
        files: [
            ...scaffoldFiles,
            ...input.template.pages.map((page) => createRouteFile(input.template, page, input.project.name, input.plan.intentSummary)),
        ],
