...
export function createActivityRoute(deps: ActivityRouteDeps = {}) {
  ...
  activityRoute.get("/", authMiddleware, loadOrgContextMiddleware, async (c) => {
    try {
...
const activityRoute = createActivityRoute();
