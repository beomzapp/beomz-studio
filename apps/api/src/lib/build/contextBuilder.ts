...
function buildSystemPrompt(
  ...
  return [
    ...
    "  • Pick the features that form the core working loop of the app.",
    "  • DO NOT attempt to build everything at once — partial, working code beats an incomplete sprawl that risks timeout.",
    "  • In the 'summary' field of deliver_customised_files, state what is included AND what comes next:",
    "    Format: \"A <theme> <app type> covering <Feature A>, <Feature B>, and <Feature C>. <Feature D> and <Feature E> are scoped for the next iteration.\"",
    "  • Never sacrifice the quality of the included features by cramming in extras.",
    "",
