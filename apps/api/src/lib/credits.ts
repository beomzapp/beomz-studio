...
export const PLAN_LIMITS = {
  free:         { credits: 200, rolloverCap: 0, signupGrant: 200, maxTopup: false, price: 0, label: "Free" },
  pro_starter:  { credits: 1000, rolloverCap: 2000, signupGrant: 0, maxTopup: true, price: 19, label: "Starter" },
  pro_builder:  { credits: 2000, rolloverCap: 4000, signupGrant: 0, maxTopup: true, price: 39, label: "Pro" },
  business:     { credits: 10000, rolloverCap: 20000, signupGrant: 0, maxTopup: true, price: 199, label: "Business" },
}
