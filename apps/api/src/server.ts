...
import adminFeatureFlagsRoute from "./routes/admin/feature-flags.js";
import adminAiModelsRoute from "./routes/admin/ai-models.js";
import adminAiProvidersRoute from "./routes/admin/ai-providers.js";
import adminHeatmapRoute from "./routes/admin/heatmap.js";
import adminUsersRoute from "./routes/admin/users.js";
import buildsCancelRoute from "./routes/builds/cancel.js";
...
import imagesGenerateRoute from "./routes/images/generate.js";
...
app.route("/admin/feature-flags", adminFeatureFlagsRoute);
app.route("/admin/ai-models", adminAiModelsRoute);
app.route("/admin/ai-providers", adminAiProvidersRoute);
app.route("/admin/heatmap", adminHeatmapRoute);
app.route("/admin/users", adminUsersRoute);
app.route("/feature-flags", featureFlagsRoute);
app.route("/images", imagesGenerateRoute);
app.route("/api/images", imagesGenerateRoute);
