...
export const initialBuildOperation = {
  ...
  examples: [
    ...
    "Build a mobile habit tracker with streaks and bottom tabs.",
    "Build a social feed for a local community app.",
    "Build a storefront for a skincare e-commerce brand.",
    "Build a portfolio site for a creative agency.",
